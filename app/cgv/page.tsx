...
const sections = [
  ...
  ["4. Prix", "Sauf indication contraire au moment de la souscription, les offres publiques de référence sont Core à 49 € par mois, Action à 99 € par mois et Scale à 249 € par mois. Les prix applicables sont ceux affichés lors de la commande, hors taxes lorsque la fiscalité applicable l'exige."],
